#ifndef __BLE_REGISTERS_H__
#define __BLE_REGISTERS_H__
...
typedef enum nRFConnectionStatus {
    Disconnected,
    Connected,
    Connecting
} nRFConnectionStatus;
